...
/**
 * A FancyButton that extends the HTMLButtonElement class.
 * @typedef {HTMLButtonElement} FancyButton
 * @property {boolean} alreadyAdded - Whether or not the button has already been added to the DOM.
 * @property {number} id - The id of the product.
 */
